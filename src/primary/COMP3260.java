...
public class COMP3260 {
	public static void main(String[] args) throws Exception {
		...
		//HashMap<String, Integer> letterFrequency = analysisPiece.periodFrequency(0);
		...
		//STUFF USED FOR c1 AND c4 POLYALPHABETIC CIPHERS
		
		//String resultString = analysisPiece.shiftWords("helpful");
